...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002451034116 -1001940661697').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002451034116 -1001940661697').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Zia')
...
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/AM_UPLOAD1')
OWNERID = int(os.environ.get('OWNERID', '1350212613'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/AM_UPLOAD1')  # Support group link (make sure bot is admin)
